...
os.environ["IMAGEIO_FFMPEG_EXE"] = "/usr/bin/ffmpeg"  # For Linux-based systems like Streamlit Cloud
...
if st.button("Process Movies"):
    ...
    for movie_name in movie_names:
        ...
        st.success(f"Uploaded to YouTube! Video ID: {video_id}")import streamlit as st
import os
import requests
from bs4 import BeautifulSoup
from pytube import YouTube
